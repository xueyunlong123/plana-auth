...
public class HashUtil {
     ...
     */
    public static byte[] sha1(@NotNull byte[] input,  byte[] salt) {
     ...
     * 对输入字符串进行sha1散列，带salt达到更高的安全性.
     */
    public static byte[] sha1(@NotNull String input,  byte[] salt) {
     ...
     * 对输入字符串进行sha1散列，带salt达到更高的安全性.
     */
    public static String sha1(@NotNull String input,  String salt) {
        return new String(digest(input.getBytes(Charsets.UTF_8), get(SHA_1_DIGEST), salt.getBytes(), 1));
    }
     ...
     */
    public static byte[] sha1(@NotNull byte[] input,  byte[] salt, int iterations) {
