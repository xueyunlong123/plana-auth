...
public class RSA {
    ...
    public static RsaKeys generateKeyPair() {
        ...
        try {
            ...
            return RsaKeys.builder().primaryKey(pri).publicKey(pub).build();

        } catch (NoSuchAlgorithmException | UnsupportedEncodingException e) {
            log.info("generate rsamodel failure: "+e.getMessage());
        }
        return null;
    ...
    public static void main(String[] args) throws Exception {
        ...
        RsaKeys rsaKeys = generateKeyPair();

        String aesEncryptData = AES.AES_Encrypt("170EA05A020A877B",JSONObject.toJSONString(rsaKeys));
        log.info("aesEncryptData is : {}",aesEncryptData);

        String resData = encrypt("170EA05A020A877B","MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDOlPKYL0uqi1aiLMQoPmLuidlemHAFoCDsi4dC87W9yEDH0QWaXrU061ko6aqSOMbGcS3do2yHCwg4svdAEumUgndeZ/T3VpIsC0I+CX1zRxAyHLUJgIaGlNGD5mfSKeW3yTPT+EOsnIXPtP173TPjXE1XQAQ2xdRyW/C6hAfsOQIDAQAB");
        log.info("resData is: {}",resData);
